...
const actionTypes = {
  ...
  ADD_MEMBRE_CANAL: "addMembreCanal"
};
...
export const actionsCreators = {
  ...
  addMembreCanal: (membreCanal) => ({
    type: actionTypes.ADD_MEMBRE_CANAL,
    value: membreCanal,
  }),
  ...
  switch (action.type) {
    ...
    case actionTypes.ADD_MEMBRE:
      return {
        ...
        membre: {
          ...state.membre,
          personnes: [...state.membre.personnes, action.value],
        },
      };

    case actionTypes.ADD_MEMBRE_CANAL:
      return {
        ...state,
        membreCanal: {
          ...state.membreCanal,
